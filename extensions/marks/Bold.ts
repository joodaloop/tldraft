...
export const Bold = Mark.create<BoldOptions>({
  ...
  renderHTML({ HTMLAttributes }) {
    return [
      "strong", // The tag name as a string
      mergeAttributes(this.options.HTMLAttributes, HTMLAttributes), // The attributes object
      0, // The "hole" where the node's content will be rendered
    ];
  },
