/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7e4deebdec57b0c03d597775d5cdfff0)
// Runtime types generated with workerd@1.20260603.1 2026-06-01 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	DocumentServer: DurableObjectNamespace<import("./worker/index").DocumentServer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "DocumentServer";
	}
